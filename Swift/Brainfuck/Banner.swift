...
public class Banner: UIView {
    ...
    private func forceUpdates() {
        guard
          ...
          let showingConstraint = showingConstraint,
          let hiddenConstraint = hiddenConstraint else { return }
        switch bannerState {
        case .hidden:
...
extension UIView {
    func constraintsEqualToSuperview(_ edgeInsets: UIEdgeInsets = .zero) -> [NSLayoutConstraint] {
